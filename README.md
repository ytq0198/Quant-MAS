...
**Current test status:** **102 passed** (local + server, 2026-06-02, Plus M1).
...
| Date | Check | Result |
|------|--------|--------|
| 2026-06-02 | Plus M1 server pytest + compare | **102 passed** (1.64s); 5-row comparison | EXP-20260602-010 |
