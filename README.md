...
**Current test status:** local **102 passed** (2026-06-02, Plus M1); server **98 passed** (2026-06-01, re-verify after pull).
...
| Date | Check | Result |
|------|--------|--------|
| 2026-06-02 | Plus M1 research baseline | **102 passed** (+4 tests) | EXP-20260602-009 |
